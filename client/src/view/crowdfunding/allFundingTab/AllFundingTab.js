...
import {getFundingDetails, handleInvestFunc} from '../contractOperate/interaction'
...
class AllFundingTab extends Component {
    ...
    handleInvest = async () => {
        let {fundingAddress, supportMoney} = this.state.seletedFundingDetail
        //需要传递选中合约地址
    ...
    render() {
        let {fundingAddress, projectName, supportMoney} = this.state.seletedFundingDetail
        return (
            <div>
